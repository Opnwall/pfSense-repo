...
### Install from the Opnwall repository (recommended)

After enabling [Opnwall pfSense Repo](https://opnwall.github.io/pfSense-repo/),
install **dnscrypt-proxy** from **System > Package Manager > Available
Packages**. Repository installation also enables normal package discovery and
upgrades.

The direct package commands below remain available for standalone
installations.
...
| `PORTVERSION` | `1.3.2` | Package version to build |
