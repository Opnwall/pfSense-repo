...
need_file "src/usr/local/share/pfSense/menu/pfSense-System_lang.xml"
need_file "src/var/lang/list"
...
chmod 0644 \
    ...
    "$STAGEDIR/usr/local/share/pfSense/menu/pfSense-System_lang.xml" \
    "$STAGEDIR/var/lang/list"
