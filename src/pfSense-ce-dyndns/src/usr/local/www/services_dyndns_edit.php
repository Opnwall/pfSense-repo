...
if ($_POST['save'] || $_POST['force']) {
	...
	$ddns_attr = array(
		"aliyun" => array("apex" => true, "wildcard" => false, "username_none" => false),
		...
		"tencentcloud" => array("apex" => true, "wildcard" => false, "username_none" => false),
		"tencentcloud-v6" => array("apex" => true, "wildcard" => false, "username_none" => false),
...
$group->setHelp('Enter the complete fully qualified domain name. Example: myhost.dyndns.org%1$s' .
				'Aliyun, Tencent Cloud: Enter @ as the hostname to update the root domain.%1$s' .
				...
				'Aliyun, Cloudflare, ClouDNS, DigitalOcean, GoDaddy, GratisDNS, Hover, Linode, LuaDNS, Name.com, Namecheap, Porkbun, Tencent Cloud: Enter the hostname and domain name separately.
...
$section->addInput(new Form_Input(
	...
	['autocomplete' => 'new-password']
			...
			'Aliyun: Enter the AccessKey ID.%1$s' .
			...
			'Tencent Cloud: Enter the SecretId.', '<br />');
...
$section->addPassword(new Form_Input(
	...
	$pconfig['password']
			...
			'Aliyun: Enter the AccessKey Secret.%1$s' .
			...
			'Tencent Cloud: Enter the SecretKey.%1$s' .
...
$section->addInput(new Form_Input(
	...
	$pconfig['zoneid']
			...
			'Route53: Enter AWS Zone ID.%1$s' .
			'Tencent Cloud: Optional record line, defaults to 默认.', '<br />');
