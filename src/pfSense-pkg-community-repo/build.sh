...
need_file "src/usr/local/www/pkg_mgr_community.php"
need_file "src/usr/local/share/pfSense-pkg-community-repo/community_repo.inc"
need_file "src/usr/local/share/pfSense-pkg-community-repo/info.xml"
need_file "src/usr/local/sbin/community-repo-ui"
need_file "src/usr/local/etc/rc.d/community_repo_ui"
need_file "src/usr/local/pkg/community_repo.xml"
...
chmod 0644 \
    "$STAGEDIR/usr/local/www/pkg_mgr_community.php" \
    "$STAGEDIR/usr/local/share/pfSense-pkg-community-repo/community_repo.inc" \
    "$STAGEDIR/usr/local/share/pfSense-pkg-community-repo/info.xml" \
    "$STAGEDIR/usr/local/pkg/community_repo.xml"
chmod 0755 \
    "$STAGEDIR/usr/local/sbin/community-repo-ui" \
    "$STAGEDIR/usr/local/etc/rc.d/community_repo_ui"
