...
function mihomo_sub_log_t($text)
{
...
if (!file_exists($log_file)) {
    echo "[" . mihomo_sub_log_t('Notice') . "] " . sprintf(mihomo_sub_log_t('Log file does not exist: %s'), $log_file) . "\n";
    exit;
}

$lines = @file($log_file, FILE_IGNORE_NEW_LINES);
if ($lines === false) {
    echo "[" . mihomo_sub_log_t('Error') . "] " . mihomo_sub_log_t('Unable to read the log file.') . "\n";
    exit;
}
